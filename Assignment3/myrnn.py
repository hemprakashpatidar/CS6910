...
Original file is located at
    https://colab.research.google.com/drive/1YqbIp8aW1XhOhVuKAr_u5DCsQ0q_0_7z
"""
...
wandb.log({"Train_Accuracy":history.history['accuracy'][99]})

wandb.log({"Loss":history.history['loss'][99]})

wandb.log({"Val_Accuracy":history.history['val_accuracy'][99]})
...
for seq_index in range(3000):
    ...
    if(seq_index%50==0):
      print(seq_index)
    if(decoded_sentence==target_texts[seq_index].split('\t')[1]):
      count+=1
Test_Acc=count/3000
Test_Acc